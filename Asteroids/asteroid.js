class asteroid {
	constructor(ctx, x,y,rad,speed,splitLvl) {
		this.ctx = ctx;
		this.x = x;
		this.y = y;
		this.radians = rad;
	...
	split() {
		if (this.splitLvl > 0) {
			arcade.game.object.asteroids.push(new asteroid(this.ctx, this.x,this.y,this.radians + 0.4,this.speed*1.1,this.splitLvl - 1));
			arcade.game.object.asteroids.push(new asteroid(this.ctx, this.x,this.y,this.radians - 0.4,this.speed*1.1,this.splitLvl - 1));
		}
