function SnakeObj(x,y) {
	...
	this.handleMovement = function() {
		...
		if (move.right && this.dir != 2 && !this.changeDir) {
			this.changeDir = true;
			this.dir = 0;
		}
			
		
		if (move.down && this.dir != 3 && !this.changeDir){
			this.changeDir = true;
			this.dir = 1;
		}
			
		
		if (move.left && this.dir != 0 && !this.changeDir) {
			this.changeDir = true;
			this.dir = 2;
		}
			
		
		if (move.up && this.dir != 1 && !this.changeDir) {
			this.changeDir = true;
			this.dir = 3;
		}
	}
