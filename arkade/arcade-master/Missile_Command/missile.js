...
function explosion(x,y) {
	...
	this.update = function() {
		...
		if (this.explosionradius < 82 && !this.explosionExpanded) {
			this.explosionradius += 0.7 * missileCommandGame.explosionSpeedMultiplier;
		}
		if (this.explosionradius >= 82) {
			this.explosionExpanded = true;
		}
		if (this.explosionExpanded && this.explosionradius > 0) {
			this.explosionradius -= 0.5 * (missileCommandGame.explosionSpeedMultiplier/1.5);
		}
