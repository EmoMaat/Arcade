class MenuOverlay {
	...
	set buttons(array){
		...
		this.MenuOverlayCanvas.height = 20 + 80 * array.length;
		// build the array bottom up
		for(let b = array.length - 1; b >= 0; b--)
		this._buttons.push(
				new Button(80, this.MenuOverlayCanvas.height - 20 - 80 * b, 400, 30, array[b][0], array[b][1], this.MenuOverlayCtx)
			)
...
class EscOverlay {
	constructor() {
		...
		EscOptions.width = 1400;
		EscOptions.height = 1000;
