...
class Mothership {
	constructor() {
		...
		if (this.direction == 1) {
			...
			this.x = canvas.width*1.25 + mother_ship.width;
		}
		this.del = false;
		this.setSound = false;
		this.y = 130;
